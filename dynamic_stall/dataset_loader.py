...
def load_cpcf_train(full_conditioning: bool, dataset_size: int):
    ...
    f = h5py.File("halton_2_comp_r128_8f.h5", "r")

    all_fields = f["fields"][: dataset_size * stat]
    all_nominal = f["nominal_condition"][: dataset_size * stat]
...
def load_cpcf_test(full_conditioning: bool):
    ...
    f = h5py.File(f"halton_{dataset_size}_comp_r128_8f.h5", "r")

    all_fields = f["fields"][:]
    all_nominal = f["nominal_condition"][:]
