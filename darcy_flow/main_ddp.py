...
def main(args):
    ...
    darcy_train = DarcyDataset(("datasets/train/p_data.csv", "datasets/train/K_data.csv"))
    darcy_valid = DarcyDataset(("datasets/valid/p_data.csv", "datasets/valid/K_data.csv"))
